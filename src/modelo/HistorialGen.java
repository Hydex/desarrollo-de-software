  ...
  void saveOnHistorialHMS() 
  {
        ...
        try {
            ...
            Statement st = cnHistorial.conectar();
               ...
               int rsSeg= st.executeUpdate("INSERT INTO HistorialAcceso (ideUsu,ideTer,horHisAcc,acnHisAcc) VALUES ('"+this.getUser()+"',"+ideTer+",'"+this.getHoraSistema()+"','"+this.getAccion()+"')");
               
        } catch (SQLException ex) {
            Logger.getLogger(HistorialGen.class.getName()).log(Level.SEVERE, null, ex);
            System.out.print("Error al guardar historial de accesos");
        }
