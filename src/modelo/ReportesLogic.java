...
public class ReportesLogic extends SistemaLogico{
    ...
    public void Procesar_reporte_ventas(DefaultTableModel mi_modelo)
    {
        
        String consultasql  = "select p.idePed, v.ideEmp, SUM(I.preItm) from Pedido p, DetalleDelPedido dd,Empleado v, Item I where dd.idePed = p.idePed group by p.idePed";
